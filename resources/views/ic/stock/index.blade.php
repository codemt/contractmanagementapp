...
<div class="title-bar">
	<h1 class="title-bar-title">
		<span class="d-ib">All IC Stock</span>
	</h1>
</div>
<div class="row gutter-xs">
	<div class="col-md-12">
		<div class="card">
			<div class="card-header bg-primary">
				<div class="card-actions">
					<button type="button" class="btn btn-xs btn-primary" data-toggle="modal" data-target="#stock_list" title="Add Stock">
						<i class="icon icon-plus-circle icon-lg"></i> Add IC Stock
					</button>
			...
			<div class="card-body">
				<div class="row">
					<form action="{{route('ic.filter')}}" method="POST">
						{{csrf_field()}}
						<div class="col-md-3">
...
@endsection
@section('modals')
@include('modals.add_ic_stock')
@include('modals.add_new_ic_stock')
...
<script type="text/javascript">
	...
	$('#add-qty').click(function(e){
		...
		console.log($('#add-quantity-form').serialize());
