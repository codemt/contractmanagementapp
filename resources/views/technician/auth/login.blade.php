...
<h3 class="login-heading">Technician</h3>
<div class="login-form">

    <form data-toggle="md-validator"  method="POST" action="{{ route('technician.login') }}">
        {{ csrf_field() }}
        ...
        <div class="md-form-group md-custom-controls">
            ...
            <a href="{{ route('technician.password.reset') }}">Forgot password?</a>
        </div>
