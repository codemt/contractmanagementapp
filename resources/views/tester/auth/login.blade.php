...
@section('content')
<h3 class="login-heading">Tester</h3>
<div class="login-form">

    <form data-toggle="md-validator"  method="POST" action="{{ route('tester.login') }}">
        {{ csrf_field() }}
        ...
        <div class="md-form-group md-custom-controls">
            ...
            <a href="{{ route('tester.password.reset') }}">Forgot password?</a>
        </div>
