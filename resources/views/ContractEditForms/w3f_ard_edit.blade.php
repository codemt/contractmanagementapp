        ...
        <div class="row">
            <div class="col-sm-10 col-sm-offset-1">
                ...
                <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9">
                            ...
                            <span id="type_of_machine" class="text-primary"></span>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <div class="md-form-group">
                                <input class="md-form-control" type="text" id="no_of_floor_v3f_ard" name="no_of_floor" spellcheck="false" data-parsley-required="true">
                                <label class="md-control-label"></label>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-4">
                            <div class="md-form-group">
                                <input class="md-form-control" type="text" id="indications_v3f_ard" name="indications" spellcheck="false" data-parsley-required="true">
                                <label class="md-control-label"></label>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-3">
                        <div class="md-form-group">
                            ...
                            <label class="md-control-label" data-parsley-required="true"></label>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-9">
                        <label class="custom-control custom-control-primary custom-radio">
                            <input class="custom-control-input" value="12V 7AH" type="radio" name="choose_battery" data-parsley-multiple required data-parsley-errors-container="#choose_battery_error">
                            <span class="custom-control-indicator"></span>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3">
                        <div class="md-form-group">
                            <input class="md-form-control" type="text" id="brake_voltage_v3f_ard" name="motor_brake_voltage" spellcheck="false" data-parsley-required="true">
                            <label class="md-control-label"></label>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4">
                        <div class="md-form-group">
                            <input class="md-form-control" type="text" id="rcam_voltage_v3f_ard" name="r_cam_voltage" spellcheck="false" data-parsley-required="true">
                            <label class="md-control-label"></label>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-9">
                        ...
                        <span id="drive_details_eror" class="text-primary"></span>
                    </div>
                </div>
                <!-- radio name ="same" -->
                <div class="row">
...
<div class="row">
    <div class="col-sm-offset-3 col-sm-9">
        ...
        <div class="md-form-group">
            ...
            <label class="md-control-label"></label>
                ...
                <div class="accessory_ups_v3f_ard_div">
                    <div class="row">
                        <label class="col-sm-3 control-label" for="">UPS :</label>
                        <div class="col-sm-9">
                            <label class="custom-control custom-control-primary custom-checkbox">
                                <input class="custom-control-input" type="radio" value="2.5" name="accessories_ups" data-parsley-multiple required data-parsley-errors-container="#ups_error">
                                <span class="custom-control-indicator"></span>
     ...
     $("#accessory_ups_v3f_ard").change(function() {
        if($(this).is(':checked'))
        {
            $(".accessory_ups_v3f_ard_div").show();
        }
        else
        {
            $(".accessory_ups_v3f_ard_div").hide();
        }
            ...
            switch($(this).attr('id'))
           {
            ...
            case 'line_chock_v_ard':
                if($('#line_chock_v_ard').is(':checked'))
                {
                    ...
                    alert('line_chock_show');
                }
                else
                {
                    $('#line_choke_qty_v_ard').hide();
                    alert('line_chock_hide');
                }
                break;
   ...
   <script type="text/javascript">
    ...
    $('input[type=radio][name="type_of_machine"][value="'+contractdetail.type_of_machine+'"]').prop("checked",true);
              ...
              if(door_mode.door_mode == 'Manual Door')
              {
                $('[data-type=auto_door]').hide();
                $('[data-type=vertical_door]').hide();
                $('[data-type=door_drive]').hide();
            ...
            if(door_mode.door_mode == 'Semi Auto')
            {
                $('[data-type=auto_door]').hide();
                $('[data-type=vertical_door]').hide();
                $('[data-type=door_drive]').hide();
